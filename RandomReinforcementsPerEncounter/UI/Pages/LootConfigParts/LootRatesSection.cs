...
namespace RandomReinforcementsPerEncounter.UI.Pages.LootConfigParts
{
    internal static class GoldRatesSection
    {
        ...
        public static void Draw()
        {
            ...
            GUILayout.Space(4);
            GUILayout.Label("Adjust the percentages.", LootConfigPage.Wrap, GUILayout.Width(520f));

            GUILayout.Space(8);
            float newGold = PercentSliderRow1000(
                "Gold drop amount",
                s.GoldDropPct,
                "Affects gold found in chests and enemies."
            );
            ...
            float newGenVal = PercentSliderRow1000(
                ...
                s.GenItemValuePct,
                "Affects the market value of magic items generated by the mod."
            );
