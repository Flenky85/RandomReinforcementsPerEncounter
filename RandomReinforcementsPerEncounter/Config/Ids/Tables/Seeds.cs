namespace RandomReinforcementsPerEncounter.Config.Ids.Tables
{
    internal static class Seed
    {
        ...
        public const string nauseated = "nauseated";
